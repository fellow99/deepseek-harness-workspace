...
| 分发目标（harmony） | `deepseek-harness-harmony/AppScope/resources/base/media/` | `app_icon.png`/`startIcon.png`/`icon.png`/`product_logo_32.png`（源：`logo-1024-with-bg.png`，不透明） |
